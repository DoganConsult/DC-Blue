...
@Component({
  ...
  standalone: true,
  template: `
    <section class="py-20 lg:py-24" id="cta" style="background: linear-gradient(135deg, #1f49c7 0%, #2f6df3 100%);">
      <div class="max-w-[1200px] mx-auto px-6 lg:px-8 text-center">
        ...
        <button (click)="router.navigate(['/inquiry'])"
                class="inline-flex items-center gap-2 px-8 py-4 bg-gold-accent text-[#1D2433] rounded-xl font-bold text-[15px] hover:shadow-[0_8px_30px_rgba(244,178,35,0.3)] hover:-translate-y-0.5 transition-all duration-300">
