...
@Component({
  ...
  standalone: true,
  template: `
    <section class="py-20 px-4 bg-th-bg-alt" id="transform">
      <div class="container mx-auto max-w-6xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div class="bg-th-card rounded-2xl p-6 border border-emerald-200 border-2">
